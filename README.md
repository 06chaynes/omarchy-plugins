...
| **GitHub Tracker** | [`io.github.06chaynes.github-tracker`](plugins/io.github.06chaynes.github-tracker) | Real-time GitHub dashboard tracking pinned repos, open PRs, review requests, and live CI/CD action alerts. | Local / Original |
